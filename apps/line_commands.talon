tag: line_commands
-
#<user.selection_verbs> this: user.idea_select(selection_verbs)
<user.selection_verbs> whole line <number>: user.select_line(selection_verbs, number)
...
#<user.selection_verbs> next <phrase> [over]: user.idea_select(selection_verbs, "find next {phrase}")
#<user.selection_verbs> last <phrase> [over]: user.idea_select(selection_verbs, "find prev {phrase}")

# Movement
go line <number>: user.go_to_line(number)

#todo
#<user.navigation_verbs> next (error | air): 
#<user.navigation_verbs> last (error | air): 
...
#<user.navigation_verbs> next <phrase> [over]: user.idea_movement(navigation_verbs, "find next {phrase}, action EditorRight")
#<user.navigation_verbs> last <phrase> [over]: user.idea_movement(navigation_verbs, "find prev {phrase}, action EditorRight")
