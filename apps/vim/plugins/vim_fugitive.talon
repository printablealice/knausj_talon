...
(fugitive|git) blame: user.vim_command_mode(":Git_blame\n")
...
(fugitive|git) fetch: user.vim_command_mode(":Git_fetch ")
...
(fugitive|git) merge tool: user.vim_command_mode(":Git_mergetool")
(fugitive|git) move: user.vim_command_mode(":GMove ")
(fugitive|git) pull: user.vim_command_mode(":G pull ")
(fugitive|git) push: user.vim_command_mode(":Git_push ")
